    ...
    render() {
        ...
        const submitForm = (e) => {
            ...
            if (errors == null) {
                ...
                delete state.loadintable;
                axios
                    .post(`${baseUrl}api/OnlineLectures`, state, {
                        headers: { Authorization: `Bearer ${token}` },
                    })
                    .then((res) => {
                        if (res.status == 200) {
        ...
        const { name, subjectId, lectureLink, description, date, today, time, errors, loadintable } = this.state;

        return (
            <div className="main-content">
                <div className="dashboard-header">
                    <h5>اضافة محاضرة مباشرة جديدة</h5>
                </div>
